...
echo "  2. Go to ${GITHUB_URL:-https://github.com/basher83/Hercules-Power-Templates}/releases"
...
echo "  curl -fsSL https://github.com/basher83/Hercules-Power-Templates/releases/latest/download/install.sh | bash"
echo "  # or"
echo "  wget -qO- https://github.com/basher83/Hercules-Power-Templates/releases/latest/download/install.sh | bash"
